  ...
  return (
    ...
    >
      <div className="p-4 mt-auto z-20 flex flex-col gap-2 pb-4">
        <h1 className="font-semibold truncate text-white text-2xl">{title}</h1>
        ...
        <p className="truncat line-clamp-3  font-light opacity-75 text-white ">
          {parse(summary)}
        </p>
        <p className="px-2 py-1 rounded text-opacity-85 text-sm text-white bg-gradient-to-r from-amber-500 to-orange-500 mt-auto self-end font-medium text-end">
          Check recipe {'->'}
        </p>
      </div>
